...
//
% import "base/Macros.h" % import "base/RefCounted.h" % import "base/memory/Memory.h"

    // ----- Include Section ------
    // Brief: Include header files in which classes and methods will be bound
    % include "renderer/gfx-base/GFXDef-common.h" % include "renderer/gfx-base/GFXObject.h" % include "renderer/gfx-base/GFXBuffer.h" % include "renderer/gfx-base/GFXCommandBuffer.h" % include "renderer/gfx-base/GFXDescriptorSet.h" % include "renderer/gfx-base/GFXDescriptorSetLayout.h" % include "renderer/gfx-base/GFXFramebuffer.h" % include "renderer/gfx-base/GFXInputAssembler.h" % include "renderer/gfx-base/GFXPipelineLayout.h" % include "renderer/gfx-base/GFXPipelineState.h" % include "renderer/gfx-base/GFXQueryPool.h" % include "renderer/gfx-base/GFXQueue.h" % include "renderer/gfx-base/GFXRenderPass.h" % include "renderer/gfx-base/GFXShader.h" % include "renderer/gfx-base/GFXSwapchain.h" % include "renderer/gfx-base/GFXTexture.h"

    % include "renderer/gfx-base/states/GFXGeneralBarrier.h" % include "renderer/gfx-base/states/GFXSampler.h" % include "renderer/gfx-base/states/GFXTextureBarrier.h" % include "renderer/gfx-base/states/GFXBufferBarrier.h"
